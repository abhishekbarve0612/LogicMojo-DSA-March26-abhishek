package classAssignments.week2.maximumSubArray;
...
class Result {
    ...
    public static List<Integer> maxSubarray(List<Integer> arr) {
        ...
        for (int i = 0; i < arr.size(); i++) {
            int num = arr.get(i);
            minValue = Math.max(minValue, num);
            if (num > 0) maxSubSequenceSum += num;
        ...
        res.add(maxSubArraySum);
        res.add(maxSubSequenceSum == 0 ? minValue : maxSubSequenceSum);
